...
CREATE TABLE `ai_session_turns` (
  ...
  `delta_messages` JSON NULL COMMENT 'Turn delta messages (new_messages, policy-immune)',
  `status` VARCHAR(32) NOT NULL COMMENT 'Status',
  `capture_state` VARCHAR(32) NOT NULL DEFAULT 'complete' COMMENT 'Message capture state (complete/partial/unavailable)',
