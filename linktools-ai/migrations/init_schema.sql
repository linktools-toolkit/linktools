...
CREATE TABLE ai_state_aliases (
    ...
    KEY ix_record_key_digest (record_key_digest), KEY ix_store_digest_alias_digest (store_digest, alias_digest),
    KEY ix_updated_at (updated_at), KEY ix_created_at (created_at)
...
CREATE TABLE ai_state_facts (
    ...
    KEY ix_store_digest_stream_digest_sequence (store_digest, stream_digest, sequence),
    KEY ix_updated_at (updated_at), KEY ix_created_at (created_at)
...
CREATE TABLE ai_state_sequences (
    ...
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update timestamp',
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Creation timestamp',
    PRIMARY KEY (id), UNIQUE KEY uk_key_digest (key_digest), KEY ix_store_digest_key_digest (store_digest, key_digest),
    KEY ix_updated_at (updated_at), KEY ix_created_at (created_at)
...
CREATE TABLE ai_state_operations (
    ...
    KEY ix_stream_digest_state_sequence (stream_digest, state, sequence), KEY ix_store_digest_key_digest (store_digest, key_digest),
    KEY ix_updated_at (updated_at), KEY ix_created_at (created_at)
