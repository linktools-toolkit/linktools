...
class Command(BaseCommand):
    ...
    def init_arguments(self, parser: "CommandParser") -> None:
        ...
        parser.add_argument("--memory", default=None, help="caller-owned memory namespace (default: workspace id)")
    ...
    def run(self, args: Namespace) -> int:
        try:
            ...
            asyncio.run(ACPApplication.for_workspace(workspace).serve(memory_namespace=memory_namespace))
