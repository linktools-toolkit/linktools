#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""FilesystemMemoryBackend: single-process file backend for MemoryStore (the Protocol in
...
Flat records are read with a synthesized ``DEFAULT_TENANT_ID`` tenant and
