...
class Runtime:
    ...
    async def inspect(self, spec: AgentSpec) -> "CapabilityInspection":
        ...
        resolution surfaces as a warning. See :mod:`linktools.ai.runtime.assembly.inspection`."""
    ...
    async def aclose(self) -> None:
        """Release runtime-owned assets (MCP connections). Idempotent."""
        if self._components.mcp_connection_pool is not None:
            await self._components.mcp_connection_pool.close()
