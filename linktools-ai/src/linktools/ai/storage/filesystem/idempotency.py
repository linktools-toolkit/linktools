#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""FilesystemIdempotencyStore: per-record JSON files at root/{scope}/{key}.json.

Mirrors FilesystemApprovalStore / FilesystemRunStore patterns: atomic writes (temp-file
