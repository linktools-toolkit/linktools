...
stores are wired, it also captures a full :class:`EvalSnapshot` (run record,
...
class DirectEvalExecutor:
    ...
    ) -> "tuple[str | None, EvalSnapshot | None]":
        """Build a full EvalSnapshot by sealing the run record, run definition,
