...
class CapabilityRepositoryProtocol(Protocol):
    ...
    async def delete_capability(self, kind: str, capability_id: str) -> int: ...

    async def restore_builtin_files(self, kind: str, capability_id: str) -> int: ...

    async def rename_capability(self, kind: str, old_capability_id: str, new_capability_id: str) -> int: ...
