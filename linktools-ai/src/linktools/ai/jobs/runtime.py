#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""JobRuntime: the reliable-task facade.
...
from .store import TaskRunTimeoutError, TaskCancellationDidNotConvergeError, JobStore


@dataclass(frozen=True, slots=True)
class JobRuntimeOptions:
...
class JobRuntime:
    def __init__(
        ...
        *,
        ...
        options: "JobRuntimeOptions | None" = None,
    ...
    @property
    def options(self) -> JobRuntimeOptions:
