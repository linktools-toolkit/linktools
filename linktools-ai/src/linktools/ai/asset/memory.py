#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""MemoryAssetBackend: a dependency-free AssetBackend used to exercise the
Protocol contract and as one of the parametrized backends in the AssetStore
contract-test suite."""
...
class MemoryAssetBackend:
    ...
    async def raw_get(self, path: AssetPath, *, include_content: bool = True):
        ...
        if key in self._entries:
            ...
            if not include_content:
                return Found(resource=Asset(info=info, content=b""))
    ...
    async def raw_propfind(
        ...
        # raw_move / raw_stat -- AssetStore uses the basic implementation
