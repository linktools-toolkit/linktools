#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""linktools.ai.tool.mcp: MCP server capability wiring. Re-exports the extended
...
from .models import MCPConnectionRef, MCPDiscoveryResult, MCPExposedTool, MCPToolInfo
