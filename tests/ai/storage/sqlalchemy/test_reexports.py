...
test proves SqlAlchemyResourceBackend is now re-exported the same way,
resolving to the exact same object as the deep submodule import."""


def test_sqlalchemy_resource_backend_reexport_identity():
    from linktools.ai.storage.sqlalchemy import SqlAlchemyResourceBackend as Shallow
    from linktools.ai.storage.sqlalchemy.resource import SqlAlchemyResourceBackend as Deep
