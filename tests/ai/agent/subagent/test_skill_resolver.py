...
from linktools.ai.errors import SpecNotFoundError, SubagentResolutionError
from linktools.ai.agent.skill.private import ActiveSkillContext
from linktools.ai.agent.subagent.skill_resolver import (
    CallSubagentInput,
