#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for retrieval.retriever: Retriever Protocol + MemoryRetriever.
MemoryRetriever projects MemoryRecord -> Document over an async MemoryStore."""

import asyncio

from linktools.ai.agent.retrieval.document import Document
from linktools.ai.agent.retrieval.retriever import MemoryRetriever, Retriever
from linktools.ai.agent.retrieval.scope import RetrievalScope
from linktools.ai.agent.memory.models import MemoryMatch, MemoryRecord
