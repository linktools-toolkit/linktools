#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Frozen Runtime v2 persistence protocol fixtures."""
...
def test_current_wire_registry_matches_golden_manifest() -> None:
    ...
    assert fixture["wire_type_ids"] == [wire_id for wire_id, _ in _V2_WIRE_TYPES]
    assert fixture["enum_wire_type_ids"] == [
        wire_id for wire_id, _ in _V2_ENUM_WIRE_TYPES
    ]
