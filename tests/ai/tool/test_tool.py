#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for tool/catalog.py: ToolSpec declaration + ToolSpecIndex loading."""
...
from linktools.ai.agent.tool.models import ToolSpec
...
def test_get_returns_tool_spec_from_yaml(tmp_path):
    ...
    registry = ToolSpecIndex.from_specloader(SpecLoader.from_filesystem(tmp_path / "tools"))
...
# 6a. Malformed YAML -> SpecParseError.
