#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for registry/agent.py: AgentRegistry resolves AgentSpec from
...
from linktools.ai.registry.agent import AgentRegistry, parse_agent_spec
...
def test_get_returns_agent_spec_from_markdown(tmp_path):
    ...
    registry = AgentRegistry(SpecLoader.from_filesystem(tmp_path / "agents"))
