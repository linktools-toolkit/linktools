...
from linktools.ai.execution.evaluation.evaluators.delegation import DelegationEvaluator
from linktools.ai.execution.evaluation.evaluators.usage import UsageEvaluator
from linktools.ai.execution.evaluation.models import EvalCase, EvalExecution
from linktools.ai.execution.evaluation.snapshot import EvalSnapshot
...
def _snapshot(events=1) -> EvalSnapshot:
    return EvalSnapshot(
        run_id="r1",
