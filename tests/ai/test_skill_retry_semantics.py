#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Skill tool regression for model-visible selection misses."""
...
async def test_missing_skill_id_is_tool_failure() -> None:
    ...
    with pytest.raises(ToolFailed, match="skill not found"):
