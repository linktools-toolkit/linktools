#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for swarm/catalog.py: SwarmCatalog resolves SwarmSpec from {name}.yaml
...
def test_get_returns_swarm_spec_from_yaml(tmp_path):
    ...
    registry = SwarmCatalog.from_specloader(SpecLoader.from_filesystem(tmp_path / "swarms"))
...
def test_get_missing_agents_raises_invalid_spec(tmp_path):
    ...
    registry = SwarmCatalog.from_specloader(SpecLoader.from_filesystem(swarms))
