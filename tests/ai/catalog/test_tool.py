#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Tests for tool/catalog.py: ToolSpec declaration + ToolCatalog loading."""
...
def test_get_returns_tool_spec_from_yaml(tmp_path):
    ...
    registry = ToolCatalog.from_specloader(SpecLoader.from_filesystem(tmp_path / "tools"))
...
def test_get_caches_spec_per_revision():
    ...
    registry = ToolCatalog.from_specloader(loader)
