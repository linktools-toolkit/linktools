...
"""linktools.ai.agent.capability already exports CapabilityRef/CapabilityRuntimeOptions/
...
def test_capability_tool_exposure_policy_reexport_identity():
    from linktools.ai.agent.capability import CapabilityToolExposurePolicy as Shallow
    from linktools.ai.agent.capability.exposure import CapabilityToolExposurePolicy as Deep
...
def test_existing_capability_exports_still_work():
    ...
    from linktools.ai.agent.capability import (
...
def test_capability_provider_registry_reexport_identity():
    ...
    from linktools.ai.agent.capability import CapabilityProviderRegistry as Shallow
    from linktools.ai.agent.capability.registry import CapabilityProviderRegistry as Deep
    assert Shallow is Deep
